...
from methods.bilstm_garf.main import main as bilstm_garf
from .experiment import Experiment


class BiLSTMGARFExperiment(Experiment):
    def __init__(self, error_rate: float, method_name: str, dataset: str, error_generator: int = 1):
        ...
        self.base_dir = os.path.join(os.getcwd(), "methods", "bilstm_garf")
    ...
    def worker(kwargs: Dict[str, Any] = dict()):
        ...
        os.chdir(os.path.join(os.getcwd(), "methods", "bilstm_garf"))
        bilstm_garf(flag, order, remove_amount_of_error_tuples, dataset)
