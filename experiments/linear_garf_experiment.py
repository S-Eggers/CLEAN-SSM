...
from methods.fd_garf.main import main as linear_garf
...
class LinearGARFExperiment(Experiment):
    def __init__(self, error_rate: float, method_name: str, dataset: str, error_generator: int = 1):
        ...
        self.base_dir = os.path.join(os.getcwd(), "methods", "linear_garf")
    ...
    def worker(kwargs: Dict[str, Any] = dict()):
        ...
        os.chdir(os.path.join(os.getcwd(), "methods", "linear_garf"))
        linear_garf(flag, order, remove_amount_of_error_tuples, dataset)
