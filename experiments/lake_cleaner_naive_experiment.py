...
from methods.lake_cleaner_naive.main import main as lake_cleaner_naive


class LakeCleanerNaiveExperiment(Experiment):
    def __init__(self, error_rate: float, method_name: str, dataset: str, error_generator: int = 1):
        ...
        self.base_dir = os.path.join(os.getcwd(), "methods", "lake_cleaner_naive")
