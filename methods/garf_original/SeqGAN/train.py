from methods.garf_original.SeqGAN.models import GeneratorPretraining, Discriminator
from methods.garf_original.SeqGAN.utils import GeneratorPretrainingGenerator, DiscriminatorGenerator
from methods.garf_original.SeqGAN.rl import Agent, Environment
...
class Trainer(object):
    ...
    def __init__(self, order, B, T, g_E, g_H, d_E, d_H, d_dropout, generate_samples,path_pos, path_neg, path_rules, g_lr=1e-3, d_lr=1e-3, n_sample=16,  init_eps=0.1, remove_amount_of_error_tuples=0):
        ...
        self.d_data = DiscriminatorGenerator(path_pos=self.path_pos, order=order, path_neg=self.path_neg, B=self.B, shuffle=True, remove_amount_of_error_tuples=remove_amount_of_error_tuples) # The next method produces pos data and neg data
    ...
    def get_parameter_count(self):
        return self.generator_pre.count_params()
