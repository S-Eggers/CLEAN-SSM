import time
from methods.distilled_garf.SeqGAN.generator_train import GeneratorTrainer
from methods.distilled_garf.SeqGAN.get_config import get_config
from methods.distilled_garf.att_reverse import att_reverse
from methods.distilled_garf.rule_sample import rule_sample
...
def main(flag=2, order=1, remove_amount_of_error_tuples=0.0, dataset="Hosp_rules"):
    ...
    if flag == 0 or flag == 2:
        ...
        trainer.distill(g_epochs=config["g_pre_epochs"])
        
        trainer.reflect_dis_train()
